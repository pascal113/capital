            ...
            <section id="production" className="section">
                <div className="container">
                    ...
                    <div className='production_dosage_draw'>
                        <img src="/images/pages/product_curve_line.png" alt="" className='production_dosage_curve_lines desktop_image' />
                        <img src="/images/pages/product_curve_line_m.png" alt="" className='production_dosage_curve_lines mobile_image' />
